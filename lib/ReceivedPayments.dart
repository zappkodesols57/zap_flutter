...
class ReceivedPayment extends StatefulWidget {
  const ReceivedPayment({Key key}) : super(key: key);

  @override
  _ReceivedPaymentState createState() => _ReceivedPaymentState();
}

class _ReceivedPaymentState extends State<ReceivedPayment> {
  @override
  @override
