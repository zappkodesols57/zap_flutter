...
class SentPayment extends StatefulWidget {
  const SentPayment({Key key}) : super(key: key);

  @override
  _SentPaymentState createState() => _SentPaymentState();
}

class _SentPaymentState extends State<SentPayment> {
  @override
  @override
