...
class _BusinessSettingState extends State<BusinessSetting> {
  ...
  Widget build(BuildContext context) {
    ...
    return WillPopScope( onWillPop: () async => false ,
        child: Scaffold(
          ...
          key: _scaffoldKey,
          appBar: AppBar(
            title: Text("Business Settings".tr,style: TextStyle(fontFamily: "Sans"),),
                  ...
                  children: <Widget>[
                    ...
                    Padding(
                      ...
                      child: Container(
                        ...
                        child: Padding(
                          ...
                          child: Text("Billing Details".tr,textAlign: TextAlign.center,
                            style: TextStyle(
                              fontSize: 20,
                              color: Colors.white,
                    ...
                    Padding(
                      ...
                      child: Container(
                        ...
                        child: Padding(
                          padding: const EdgeInsets.only(top: 15.0),
                          child: Text("Business Basic Details".tr,textAlign: TextAlign.center,
                            style: TextStyle(
                              fontSize: 20,
                              color: Colors.white,
                              fontWeight: FontWeight.bold,
                    ...
                    Padding(
                      ...
                      child: Container(
                        ...
                        child: Padding(
                          padding: const EdgeInsets.only(top: 15.0),
                          child: Text("Address Details".tr,textAlign: TextAlign.center,
                            style: TextStyle(
                              fontSize: 20,
                              color: Colors.white,
                              fontWeight: FontWeight.bold,
                    ...
                    Padding(
                      ...
                      child: Container(
                        ...
                        child: Padding(
                          padding: const EdgeInsets.only(top: 15.0),
                          child: Text("Owner Details (Contact Person)".tr,textAlign: TextAlign.center,
                            style: TextStyle(
                              fontSize: 17,
                              color: Colors.white,
                              fontWeight: FontWeight.bold,
                    ...
                    Padding(
                      ...
                      child: Container(
                        ...
                        child: Padding(
                          padding: const EdgeInsets.only(top: 15.0),
                          child: Text("Bank Details".tr,textAlign: TextAlign.center,
                            style: TextStyle(
                              fontSize: 20,
                              color: Colors.white,
                              fontWeight: FontWeight.bold,
                          ...
                          Container(
                            ...
                            child: new TextField(
                              ...
                              decoration: InputDecoration(
                                ...
                                labelStyle: TextStyle(
                                    fontFamily: "PoppinsLight", fontSize: 15.0, color: kPrimaryColorDarkBlue),
                              ),
                            ),
                          ),
                        ],
                    ...
                    Padding(
                      ...
                      child: Container(
                        ...
                        child: Padding(
                          padding: const EdgeInsets.only(top: 15.0),
                          child: Text("Business Documents".tr,textAlign: TextAlign.center,
                            style: TextStyle(
                              fontSize: 20,
                              color: Colors.white,
                              fontWeight: FontWeight.bold,
                            ...
                            children: [
                              Container(
                                ...
                                child: new CheckboxListTile(
                                    title: Text("Required Payment Integration".tr,style: TextStyle(fontWeight: FontWeight.bold),),
                              ...
                              Container(
                                ...
                                child: new TextField(
                                  ...
                                  decoration: InputDecoration(
                                    ...
                                    labelText: "GSTIN Certificate".tr,
                                    labelStyle: TextStyle(
                                        fontFamily: "PoppinsLight", fontSize: 13.0, color: kPrimaryColorDarkBlue),
                                ...
                                Container(
                                  ...
                                  child: new TextField(
                                    ...
                                    decoration: InputDecoration(
                                      ...
                                      labelText: "PayU Schedule Upload".tr,
                                      labelStyle: TextStyle(
                                          fontFamily: "PoppinsLight", fontSize: 13.0, color: kPrimaryColorDarkBlue),
                              ...
                              Padding(
                                ...
                                child: Container(
                                  ...
                                  child: Padding(
                                    padding: const EdgeInsets.only(top: 15.0),
                                    child: Text("Uploads".tr,textAlign: TextAlign.center,
                                      style: TextStyle(
                                        fontSize: 20,
                                        color: Colors.white,
                                        fontWeight: FontWeight.bold,
                              ...
                              Container(
                                ...
                                child: new TextField(
                                  ...
                                  decoration: InputDecoration(
                                    ...
                                    labelText: "Authorised Signature".tr,
                                    labelStyle: TextStyle(
                                        fontFamily: "PoppinsLight", fontSize: 13.0, color: kPrimaryColorDarkBlue),
  ...
  updateDetails() {
    // setDetails();
    showInSnackBar("Business Settings updated successfully".tr);
  }
}
